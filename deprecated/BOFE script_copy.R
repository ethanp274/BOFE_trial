...
T0  <- read_sav('../Master data sets 18.02.2024/Master data sets 18.02.2024/T0.sav')
T3  <- read_sav('T3.sav')
T6  <- read_sav('T6.sav')
T9  <- read_sav('T9.sav')
...
#Costs C
#economic_data$cost1B_C6<- NA
#economic_data$cost1B_C6[economic_data$D1.3_0==1 & economic_data$D1.4_0=="cg (control group)"] <- rowSums(economic_data[, c("2022_06_C","2022_07_C", "2022_08_C", "2022_09_C", "2022_10_C", "2022_11_C")], na.rm=TRUE)
#economic_data$cost1B_C12 <- NA
#economic_data$cost1B_C12[economic_data$D1.3_0==1 & economic_data$D1.4_0=="cg (control group)"] <- rowSums(economic_data[, c("2022_12_C","2023_01_C", "2023_02_C", "2023_03_C", "2023_04_C", "2023_05_C")], na.rm=TRUE)  

#Costs M
#economic_data$cost1B_M6 <- NA
#economic_data$cost1B_M6[economic_data$D1.3_0==1 & economic_data$D1.4_0=="cg (control group)"] <- rowSums(economic_data[, c("2022_06_M","2022_07_M", "2022_08_M", "2022_09_M", "2022_10_M", "2022_11_M")], na.rm=TRUE)  
#economic_data$cost1B_M12 <- NA
#economic_data$cost1B_M12[economic_data$D1.3_0==1 & economic_data$D1.4_0=="cg (control group)"] <- rowSums(economic_data[, c("2022_12_M","2023_01_M", "2023_02_M", "2023_03_M", "2023_04_M", "2023_05_M")], na.rm=TRUE)  

#Costs F
#economic_data$cost1B_F6 <- NA
#economic_data$cost1B_F6[economic_data$D1.3_0==1 & economic_data$D1.4_0=="cg (control group)"] <- rowSums(economic_data[, c("2022_06_F","2022_07_F", "2022_08_F", "2022_09_F", "2022_10_F", "2022_11_F")], na.rm=TRUE)  
#economic_data$cost1B_F12 <- NA
#economic_data$cost1B_F12[economic_data$D1.3_0==1 & economic_data$D1.4_0=="cg (control group)"] <- rowSums(economic_data[, c("2022_12_F","2023_01_F", "2023_02_F", "2023_03_F", "2023_04_F", "2023_05_F")], na.rm=TRUE)  

#Costs H
#economic_data$cost1B_H6 <- NA
#economic_data$cost1B_H6[economic_data$D1.3_0==1 & economic_data$D1.4_0=="cg (control group)"] <- rowSums(economic_data[, c("2022_06_H","2022_07_H", "2022_08_H", "2022_09_H", "2022_10_H", "2022_11_H")], na.rm=TRUE)  
#economic_data$cost1B_H12 <- NA
#economic_data$cost1B_H12[economic_data$D1.3_0==1 & economic_data$D1.4_0=="cg (control group)"] <- rowSums(economic_data[, c("2022_12_H","2023_01_H", "2023_02_H", "2023_03_H", "2023_04_H", "2023_05_H")], na.rm=TRUE)  

#Costs O
#economic_data$cost1B_O6 <- NA
#economic_data$cost1B_O6[economic_data$D1.3_0==1 & economic_data$D1.4_0=="cg (control group)"] <- rowSums(economic_data[, c("2022_06_O","2022_07_O", "2022_08_O", "2022_09_O", "2022_10_O", "2022_11_O")], na.rm=TRUE)  
#economic_data$cost1B_O12 <- NA
#economic_data$cost1B_O12[economic_data$D1.3_0==1 & economic_data$D1.4_0=="cg (control group)"] <- rowSums(economic_data[, c("2022_12_O","2023_01_O", "2023_02_O", "2023_03_O", "2023_04_O", "2023_05_O")], na.rm=TRUE)  

#COPD AND TREATMENT

#Costs C

#economic_data$cost2A_C6 <- NA
#economic_data$cost2A_C6[economic_data$D1.3_0==2 & economic_data$D1.4_0=="ig (intervention group)"] <- rowSums(economic_data[, c("2022_06_C","2022_07_C", "2022_08_C", "2022_09_C", "2022_10_C", "2022_11_C")], na.rm=TRUE)
#economic_data$cost2A_C12 <- NA
#economic_data$cost2A_C12[economic_data$D1.3_0==2 & economic_data$D1.4_0=="ig (intervention group)"] <- rowSums(economic_data[, c("2022_12_C","2023_01_C", "2023_02_C", "2023_03_C", "2023_04_C", "2023_05_C")], na.rm=TRUE)

#Costs M
#economic_data$cost2A_M6 <- NA
#economic_data$cost2A_M6[economic_data$D1.3_0==2 & economic_data$D1.4_0=="ig (intervention group)"] <- rowSums(economic_data[, c("2022_06_M","2022_07_M", "2022_08_M", "2022_09_M", "2022_10_M", "2022_11_M")], na.rm=TRUE)  
#economic_data$cost2A_M12 <- NA
#economic_data$cost2A_M12[economic_data$D1.3_0==2 & economic_data$D1.4_0=="ig (intervention group)"] <- rowSums(economic_data[, c("2022_12_M","2023_01_M", "2023_02_M", "2023_03_M", "2023_04_M", "2023_05_M")], na.rm=TRUE)  

#Costs F
#economic_data$cost2A_F6 <- NA
#economic_data$cost2A_F6[economic_data$D1.3_0==2 & economic_data$D1.4_0=="ig (intervention group)"] <- rowSums(economic_data[, c("2022_06_F","2022_07_F", "2022_08_F", "2022_09_F", "2022_10_F", "2022_11_F")], na.rm=TRUE)  
#economic_data$cost2A_F12 <- NA
#economic_data$cost2A_F12[economic_data$D1.3_0==2 & economic_data$D1.4_0=="ig (intervention group)"] <- rowSums(economic_data[, c("2022_12_F","2023_01_F", "2023_02_F", "2023_03_F", "2023_04_F", "2023_05_F")], na.rm=TRUE)  

#Costs H
#economic_data$cost2A_H6 <- NA
#economic_data$cost2A_H6[economic_data$D1.3_0==2 & economic_data$D1.4_0=="ig (intervention group)"] <- rowSums(economic_data[, c("2022_06_H","2022_07_H", "2022_08_H", "2022_09_H", "2022_10_H", "2022_11_H")], na.rm=TRUE)  
#economic_data$cost2A_H12 <- NA
#economic_data$cost2A_H12[economic_data$D1.3_0==2 & economic_data$D1.4_0=="ig (intervention group)"] <- rowSums(economic_data[, c("2022_12_H","2023_01_H", "2023_02_H", "2023_03_H", "2023_04_H", "2023_05_H")], na.rm=TRUE)  

#Costs o
#economic_data$cost2A_O6 <- NA
#economic_data$cost2A_O6[economic_data$D1.3_0==2 & economic_data$D1.4_0=="ig (intervention group)"] <- rowSums(economic_data[, c("2022_06_O","2022_07_O", "2022_08_O", "2022_09_O", "2022_10_O", "2022_11_O")], na.rm=TRUE)  
#economic_data$cost2A_O12 <- NA
#economic_data$cost2A_O12[economic_data$D1.3_0==2 & economic_data$D1.4_0=="ig (intervention group)"] <- rowSums(economic_data[, c("2022_12_O","2023_01_O", "2023_02_O", "2023_03_O", "2023_04_O", "2023_05_O")], na.rm=TRUE)  

#COPD AND CONTROL

#Costs C
#economic_data$cost2B_C6 <- NA
#economic_data$cost2B_C6[economic_data$D1.3_0==2 & economic_data$D1.4_0=="cg (control group)"] <- rowSums(economic_data[, c("2022_06_C","2022_07_C", "2022_08_C", "2022_09_C", "2022_10_C", "2022_11_C")], na.rm=TRUE)
#economic_data$cost2B_C12 <- NA
#economic_data$cost2B_C12[economic_data$D1.3_0==2 & economic_data$D1.4_0=="cg (control group)"] <- rowSums(economic_data[, c("2022_12_C","2023_01_C", "2023_02_C", "2023_03_C", "2023_04_C", "2023_05_C")], na.rm=TRUE)

#Costs M
#economic_data$cost2B_M6 <- NA
#economic_data$cost2B_M6[economic_data$D1.3_0==2 & economic_data$D1.4_0=="cg (control group)"] <- rowSums(economic_data[, c("2022_06_M","2022_07_M", "2022_08_M", "2022_09_M", "2022_10_M", "2022_11_M")], na.rm=TRUE)  
#economic_data$cost2B_M12 <- NA
#economic_data$cost2B_M12[economic_data$D1.3_0==2 & economic_data$D1.4_0=="cg (control group)"] <- rowSums(economic_data[, c("2022_12_M","2023_01_M", "2023_02_M", "2023_03_M", "2023_04_M", "2023_05_M")], na.rm=TRUE)  

#Costs F
#economic_data$cost2B_F6 <- NA
#economic_data$cost2B_F6[economic_data$D1.3_0==2 & economic_data$D1.4_0=="cg (control group)"] <- rowSums(economic_data[, c("2022_06_F","2022_07_F", "2022_08_F", "2022_09_F", "2022_10_F", "2022_11_F")], na.rm=TRUE)  
#economic_data$cost2B_F12 <- NA
#economic_data$cost2B_F12[economic_data$D1.3_0==2 & economic_data$D1.4_0=="cg (control group)"] <- rowSums(economic_data[, c("2022_12_F","2023_01_F", "2023_02_F", "2023_03_F", "2023_04_F", "2023_05_F")], na.rm=TRUE)  

#Costs H
#economic_data$cost2B_H6 <- NA
#economic_data$cost2B_H6[economic_data$D1.3_0==2 & economic_data$D1.4_0=="cg (control group)"] <- rowSums(economic_data[, c("2022_06_H","2022_07_H", "2022_08_H", "2022_09_H", "2022_10_H", "2022_11_H")], na.rm=TRUE)  
#economic_data$cost2B_H12 <- NA
#economic_data$cost2B_H12[economic_data$D1.3_0==2 & economic_data$D1.4_0=="cg (control group)"] <- rowSums(economic_data[, c("2022_12_H","2023_01_H", "2023_02_H", "2023_03_H", "2023_04_H", "2023_05_H")], na.rm=TRUE)  

#Costs o
#economic_data$cost2B_O6 <- NA
#economic_data$cost2B_O6[economic_data$D1.3_0==2 & economic_data$D1.4_0=="cg (control group)"] <- rowSums(economic_data[, c("2022_06_O","2022_07_O", "2022_08_O", "2022_09_O", "2022_10_O", "2022_11_O")], na.rm=TRUE)  
#economic_data$cost2B_O12 <- NA
#economic_data$cost2B_O12[economic_data$D1.3_0==2 & economic_data$D1.4_0=="cg (control group)"] <- rowSums(economic_data[, c("2022_12_O","2023_01_O", "2023_02_O", "2023_03_O", "2023_04_O", "2023_05_O")], na.rm=TRUE)  
